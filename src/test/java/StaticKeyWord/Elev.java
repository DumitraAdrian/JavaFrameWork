...
public class Elev {
    ...
    // Static = este un heyword care are ca scop sa pastreze valoarea unei informatii pentru toate instantele unei clase
    ...
    public  void prezentareElev(){
        ...
        System.out.println("Nr elevi inscrisi la scoala este:" +nrElevi);
    }
}
